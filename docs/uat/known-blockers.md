...
|----|---------|--------|----------------|-------|
| B-CLERK | No UAT Clerk instance / keys | Registration, login, email verification, password reset, real profile UI cannot be exercised end-to-end | UAT Clerk application + `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY`, `CLERK_SECRET_KEY`, `CLERK_WEBHOOK_SIGNING_SECRET` | Client / project owner |
